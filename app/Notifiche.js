...
export default function Notifiche() {
  ...
  if (stato === 'attive') {
    return (
      <div className="card d3" style={{ background: 'var(--mint-soft)' }}>
        <p style={{ margin: 0, fontSize: 13.5, fontWeight: 700, color: '#0B5B45' }}>
          Notifiche attive — ti avvisiamo quando succede qualcosa nel tuo gruppo.
        </p>
      </div>
    );
  }
